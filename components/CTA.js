  ...
  return (
    ...
    >
      ...
      <div className="relative">
        ...
        <h2 className="font-display text-[30px] sm:text-[42px] lg:text-[52px] font-black leading-[1.08] tracking-[-1.5px] text-ink max-w-[620px] mx-auto mb-4">
          Let&apos;s Build Something
          <br />
          <em className="italic text-orange">Big Together.</em>
        </h2>
